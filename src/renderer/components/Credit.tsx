...
const Credit: React.FC<{ navigateTo: (page: string) => void }> = ({ navigateTo }) => {
    ...
    <div id='erwt'>
      <div className='header'>
        <div className='main-heading'>
          <h1 className='themed'>ERWT - Electron Boilerplated fsdfsdfsd </h1>
        </div>
        ...
        <div className='versions'>
          ...
          <div className='item'>
            <div>
              <img className='item-icon' src={icons.erwt} /> Based on ERWT
            </div>
      ...
      <div className='footer'>
        <div className='center'>
          ...
          &nbsp;&nbsp; &nbsp;&nbsp;
          <button onClick={() => navigateTo('application')}>Go to Application</button>
        </div>
      </div>
    </div>
  );
