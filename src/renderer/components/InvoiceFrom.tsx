                                        ...
                                        <table>
                                            ...
                                            <tbody>
                                                ...
                                                {products.map((product: never, index: number) => (
                                                    <tr key={index}>
                                                        {headers.map((header) => (
                                                            <td key={header}>{product[header.toLowerCase()]}</td>
                                                        ))}
                                                        <td className='icon'>
                                                            <button onClick={() => handleRemoveProduct(index)} className='red'><img src={icons.tash_icon} /></button>
                                                            <button onClick={() => handleEditButtonClick(index)} className='green'><img src={icons.edit_icon} /></button>
                                                        </td>
                                                    </tr>
                                                ))}
                        ...
                        <section className='footer'>
                            <div className='container__top'>
                                ...
                                <div className='calcul'>
                                    ...
                                    <div>
                                        <span>Taux de TVA: {tvaFormatted}</span>
                                        <input id='input_tva' type="number" value={tvaRate} onChange={e => setTvaRate(Number(e.target.value))} />
                                    </div>
